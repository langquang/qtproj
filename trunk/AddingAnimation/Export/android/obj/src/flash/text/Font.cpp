	...
	HX_STACK_ARG(enumerateDeviceFonts,"enumerateDeviceFonts");
{
		...
		if ((enumerateDeviceFonts)){
			...
			if (((::flash::text::Font_obj::__deviceFonts == null()))){
				...
				HX_STACK_LINE(84)
				::flash::text::Font_obj::nme_font_iterate_device_fonts( Dynamic(new _Function_3_1(styles)));
			}
			HX_STACK_LINE(88)
...
Void Font_obj::registerFont( ::Class font){
{
		...
		if (((instance != null()))){
			...
			if ((::Reflect_obj::hasField(font,HX_CSTRING("resourceName")))){
				HX_STACK_LINE(119)
				::flash::text::Font_obj::nme_font_register_font(instance->fontName,::flash::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::Reflect_obj::field(font,HX_CSTRING("resourceName")))));
			}
			HX_STACK_LINE(125)
...
void Font_obj::__boot()
{
	...
	freetype_import_font= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("freetype_import_font"),(int)4);
	nme_font_register_font= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_font_register_font"),(int)2);
	nme_font_iterate_device_fonts= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_font_iterate_device_fonts"),(int)1);
}
