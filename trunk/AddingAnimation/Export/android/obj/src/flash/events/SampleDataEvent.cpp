...
{
HX_STACK_PUSH("SampleDataEvent::new","flash/events/SampleDataEvent.hx",16);
...
::String SampleDataEvent_obj::toString( ){
	HX_STACK_PUSH("SampleDataEvent::toString","flash/events/SampleDataEvent.hx",34);
	HX_STACK_THIS(this);
	HX_STACK_LINE(34)
...
::flash::events::Event SampleDataEvent_obj::clone( ){
	HX_STACK_PUSH("SampleDataEvent::clone","flash/events/SampleDataEvent.hx",27);
	HX_STACK_THIS(this);
	HX_STACK_LINE(27)
	return ::flash::events::SampleDataEvent_obj::__new(this->get_type(),this->get_bubbles(),this->get_cancelable());
}
