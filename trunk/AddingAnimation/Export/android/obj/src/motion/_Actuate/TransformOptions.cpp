...
{
HX_STACK_PUSH("TransformOptions::new","motion/Actuate.hx",452);
{
	HX_STACK_LINE(454)
	this->target = target;
	HX_STACK_LINE(455)
...
::motion::actuators::IGenericActuator TransformOptions_obj::sound( Dynamic volume,Dynamic pan){
	HX_STACK_PUSH("TransformOptions::sound","motion/Actuate.hx",489);
	HX_STACK_THIS(this);
	HX_STACK_ARG(volume,"volume");
	HX_STACK_ARG(pan,"pan");
	struct _Function_1_1{
		inline static Dynamic Block( ){
			HX_STACK_PUSH("*::closure","motion/Actuate.hx",491);
			{
...
Float strength = __o_strength.Default(1);
	HX_STACK_PUSH("TransformOptions::color","motion/Actuate.hx",468);
	HX_STACK_THIS(this);
	...
	HX_STACK_ARG(alpha,"alpha");
{
		struct _Function_1_1{
			inline static Dynamic Block( Float &value,Float &strength){
				HX_STACK_PUSH("*::closure","motion/Actuate.hx",470);
				{
					hx::Anon __result = hx::Anon_obj::Create();
