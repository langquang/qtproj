...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(34)
		::flash::Lib_obj::setPackage(HX_CSTRING("OpenFL Technologies"),HX_CSTRING("AddingAnimation"),HX_CSTRING("org.openfl.samples.addinganimation"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(84)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)30,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int(::flash::Lib_obj::REQUIRE_SHADERS))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("Adding Animation"),null(),null());
	}
return null();
}
...
{
		HX_STACK_PUSH("ApplicationMain::applyScale","ApplicationMain.hx",165);
		HX_STACK_ARG(_,"_");
		HX_STACK_LINE(167)
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	HX_STACK_PUSH("ApplicationMain::getAsset","ApplicationMain.hx",213);
