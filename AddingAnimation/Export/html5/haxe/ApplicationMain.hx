...
class ApplicationMain {
	...
	public static function main() {
		...
		//flash.Lib.setPackage("OpenFL Technologies", "AddingAnimation", "org.openfl.samples.addinganimation", "1.0.0");
		...
		loaders.set("assets/B11S2Building.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader();
		loaders.set("assets/openfl.png", loader);
		total ++;
