...
Void AssetData_obj::initialize( ){
{
		...
		if ((!(::nme::AssetData_obj::initialized))){
			...
			HX_STACK_LINE(25)
			::nme::AssetData_obj::path->set(HX_CSTRING("assets/B11S2Building.png"),HX_CSTRING("assets_b11s2building_png"));
			HX_STACK_LINE(26)
			{
				HX_STACK_LINE(26)
				...
				HX_STACK_LINE(26)
				::nme::AssetData_obj::type->set(HX_CSTRING("assets/B11S2Building.png"),value);
			}
			HX_STACK_LINE(27)
			::nme::AssetData_obj::path->set(HX_CSTRING("assets/openfl.png"),HX_CSTRING("assets_openfl_png"));
			HX_STACK_LINE(28)
			{
				HX_STACK_LINE(28)
				::openfl::AssetType value = ::Reflect_obj::field(hx::ClassOf< ::openfl::AssetType >(),HX_CSTRING("image").toUpperCase());		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(28)
				::nme::AssetData_obj::type->set(HX_CSTRING("assets/openfl.png"),value);
			}
			HX_STACK_LINE(31)
