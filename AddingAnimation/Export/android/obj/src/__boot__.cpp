...
::qtframework::qtcore::Starling_obj::__register();
::qtframework::qtanimation::Juggler_obj::__register();
::qtframework::qtanimation::DelayedCall_obj::__register();
::qtframework::qtanimation::IAnimatable_obj::__register();
::qtframework::events::QTEvent_obj::__register();
...
::qtframework::events::QTEvent_obj::__boot();
::qtframework::qtanimation::IAnimatable_obj::__boot();
::qtframework::qtanimation::DelayedCall_obj::__boot();
::qtframework::qtanimation::Juggler_obj::__boot();
::qtframework::qtcore::Starling_obj::__boot();
}
