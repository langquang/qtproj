...
{
		HX_STACK_PUSH("Stage::dummyTrace","flash/display/Stage.hx",288);
		HX_STACK_THIS(this);
		HX_STACK_LINE(288)
		::haxe::Log_obj::trace(HX_CSTRING(""),hx::SourceInfo(HX_CSTRING("Stage.hx"),288,HX_CSTRING("flash.display.Stage"),HX_CSTRING("dummyTrace")));
	}
return null();
}
