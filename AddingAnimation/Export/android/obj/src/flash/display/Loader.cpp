...
{
HX_STACK_PUSH("Loader::new","flash/display/Loader.hx",26);
{
	HX_STACK_LINE(28)
	super::__construct();
	HX_STACK_LINE(30)
...
{
		HX_STACK_PUSH("Loader::contentLoaderInfo_onData","flash/display/Loader.hx",130);
		HX_STACK_THIS(this);
...
bool Loader_obj::__onComplete( ::flash::utils::ByteArray bytes){
	HX_STACK_PUSH("Loader::__onComplete","flash/display/Loader.hx",90);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Loader::unload","flash/display/Loader.hx",60);
		HX_STACK_THIS(this);
		HX_STACK_LINE(60)
...
{
		HX_STACK_PUSH("Loader::loadBytes","flash/display/Loader.hx",43);
		HX_STACK_THIS(this);
		HX_STACK_ARG(bytes,"bytes");
...
{
		HX_STACK_PUSH("Loader::load","flash/display/Loader.hx",36);
		HX_STACK_THIS(this);
